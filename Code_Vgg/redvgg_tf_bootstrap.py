...
vgg_model = VGG16(weights='imagenet', include_top=False, input_shape=(Lng, Hg, 3))
...
for i in range(B):
    ...
    transfer_model.save("vgg16_tf_bootstrap_DIBalance"+str(i)+".h5")
    transfer_model.load_weights("vgg16_tf_bootstrap_DIBalance"+str(i)+".h5")
    ...
    plt.savefig("vgg16_tf_bootstrap_DIBalance" +str(i)+ ".png")	
