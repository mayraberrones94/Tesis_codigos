...
config = jsonref.load(open("/Users/MayraBerrones/Desktop/Codigo_articulo/Segmentation/CTFTT/config/config.json"))
logBase = config["logging"]["logBase"] + ".modules.extractDicom.extractDicom"
config_extractDicom = jsonref.load(open("/Users/MayraBerrones/Desktop/Codigo_articulo/Segmentation/CTFTT/config/modules/extractDicom.json"))
