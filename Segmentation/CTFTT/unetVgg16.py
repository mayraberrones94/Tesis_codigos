...
config = jsonref.load(open("/Users/MayraBerrones/Desktop/Codigo_articulo/Segmentacion/CTFTT/config/config.json"))
logBase = config["logging"]["logBase"] + ".lib.unet.unetVGG16"
config_unet = jsonref.load(open("/Users/MayraBerrones/Desktop/Codigo_articulo/Segmentacion/CTFTT/config/modules/unet.json"))
