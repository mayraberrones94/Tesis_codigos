...
full_file_paths = get_filepaths("/Users/MayraBerrones/Documents/DDSM-CIBIS/Masks")
...
for f in full_file_paths:
  if f.endswith(".png"):
    ...
    horizontal_flip = HorizontalFlip(mask=cropped_img)
    if horizontal_flip:
    ...
    save_path = os.path.join(f"/Users/MayraBerrones/Documents/DDSM-CIBIS/Masks_enhance/{name}.png")
